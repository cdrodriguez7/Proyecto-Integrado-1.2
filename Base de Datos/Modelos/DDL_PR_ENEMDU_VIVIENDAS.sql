...
CREATE TABLE IF NOT EXISTS `viviendas_2`.`provincia` (
  ...
  `tasa_desempleo` VARCHAR(22) NULL,
  `empleo_no_remunerado` VARCHAR(22) NULL,
  `empleo_bruto` VARCHAR(22) NULL,
  `asistencia_edu_basica` VARCHAR(22) NULL,
  `tasa_analfabetismo` VARCHAR(22) NULL,
