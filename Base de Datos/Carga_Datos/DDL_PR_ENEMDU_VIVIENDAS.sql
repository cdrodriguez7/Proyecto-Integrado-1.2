-- Active: 1689118080257@@127.0.0.1@3306@pruebaPa
...
DROP DATABASE IF EXISTS `mydb_integrador`;
CREATE SCHEMA IF NOT EXISTS `mydb_integrador` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci ;
USE `mydb_integrador` ;

-- -----------------------------------------------------
-- Table `mydb_integrador`.`provincia`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb_integrador`.`provincia` (
...
-- -----------------------------------------------------
-- Table `mydb_integrador`.`canton`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb_integrador`.`canton` (
  ...
  CONSTRAINT `canton_ibfk_1`
    ...
    REFERENCES `mydb_integrador`.`provincia` (`cod_provincia`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;
...
-- -----------------------------------------------------
-- Table `mydb_integrador`.`parroquia`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb_integrador`.`parroquia` (
  `cod_parroquia` VARCHAR(55) NOT NULL,
  `nombre_parroquia` VARCHAR(55) NOT NULL,
  ...
  CONSTRAINT `ciudad_ibfk_1`
    ...
    REFERENCES `mydb_integrador`.`canton` (`cod_canton`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;
...
-- -----------------------------------------------------
-- Table `mydb_integrador`.`vivienda`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb_integrador`.`vivienda` (
  ...
  CONSTRAINT `vivienda_ibfk_1`
    ...
    REFERENCES `mydb_integrador`.`parroquia` (`cod_parroquia`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;
...
-- -----------------------------------------------------
-- Table `mydb_integrador`.`hogar`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb_integrador`.`hogar` (
  ...
  CONSTRAINT `hogar_ibfk_1`
    ...
    REFERENCES `mydb_integrador`.`vivienda` (`id_vivienda`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;
...
-- -----------------------------------------------------
-- Table `mydb_integrador`.`cuartos`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb_integrador`.`cuartos` (
  ...
  CONSTRAINT `fk_cuartos_hogar1`
    ...
    REFERENCES `mydb_integrador`.`hogar` (`id_hogar`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
...
-- -----------------------------------------------------
-- Table `mydb_integrador`.`datos_arriendo`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb_integrador`.`datos_arriendo` (
...
-- -----------------------------------------------------
-- Table `mydb_integrador`.`hogar_combustibles`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb_integrador`.`hogar_combustibles` (
  `id_hogar` VARCHAR(22) NOT NULL,
  `tipo_combustible` VARCHAR(22) NOT NULL,
  `gasto_combustible` INT NOT NULL,
  PRIMARY KEY (`id_hogar`, `tipo_combustible`),
...
-- -----------------------------------------------------
-- Table `mydb_integrador`.`servicios_basicos`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb_integrador`.`servicios_basicos` (
